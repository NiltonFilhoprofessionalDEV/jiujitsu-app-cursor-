...
function buildQuery(values: NotificationsFilterValues): string {
...
function normalize(values: NotificationsFilterValues) {
  return {
    q: values.q ?? "",
...
export function NotificationsFilterBar({
  ...
  initial: NotificationsFilterValues;
}) {
      ...
      <Sheet open={open} onOpenChange={setOpen}>
        ...
        >
          <SheetHeader className="border-b border-border px-4 pb-3 pt-4">
            ...
            <SheetDescription>
              Mostre todas ou só as não lidas.
            </SheetDescription>
          </SheetHeader>
